...
var render = function(){
	...
	for(var i=1;i<=total;i++){
		...
		tmpl +='<li data-id="'+i+'" class="animated rollIn" style="width:'+picWidth+'px;height:'+picWidth+'px;padding-top:'+padding+'px;padding-left:'+p+'px;"><canvas id="cvs_'+i+'"></canvas></li>';
